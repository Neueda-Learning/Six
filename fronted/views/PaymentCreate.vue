...
<template>
  <section class="create-page">
    ...
    <!-- Element Plus 表单：ref 绑定实例便于调用 validate；rules 绑定校验规则；label-width 统一标签宽度 -->
    <el-form
      ref="formRef"
      :model="form"
      :rules="rules"
    ...
    >
      ...
      <el-form-item label="From Account" prop="fromAccount">
        <el-input v-model="form.fromAccount" placeholder="e.g. ACC10001" />
      </el-form-item>

      <!-- 目标账户 -->
      <el-form-item label="To Account" prop="toAccount">
        <el-input v-model="form.toAccount" placeholder="e.g. ACC20002" />
      </el-form-item>
      ...
      <el-form-item label="Remark" prop="remark">
        <el-input v-model="form.remark" placeholder="Optional note, e.g. invoice-2026-07" />
      </el-form-item>
      ...
      <el-form-item label="Idempotency Key" prop="idempotencyKey">
        <el-input v-model="form.idempotencyKey">
          <template #append>
            <el-button @click="regenerateIdempotencyKey">Regenerate</el-button>
          </template>
        </el-input>
      </el-form-item>
